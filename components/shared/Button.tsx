...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', fullWidth = false, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary text-primary-foreground hover:brightness-110 focus:ring-primary shadow-[var(--shadow-button)]',
      secondary: 'bg-secondary text-secondary-foreground hover:brightness-110 focus:ring-secondary',
